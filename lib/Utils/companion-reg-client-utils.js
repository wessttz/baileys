/**
 * Utilities for companion registration and QR pairing data.
 * Based on @blckrose/baileys v2.0.5
 */
...
/**
 * Builds the QR pairing string in the format WA expects:
 * ref,noiseKeyB64,identityKeyB64,advB64,platformId
 */
